...
if(isset($_POST['btnDangKy']))
{
    ...
    try {
        ...
        $mail->Username = 'tmtkimk19012@cusc.ctu.edu.vn';     // SMTP username
        $mail->Password = 'hjwsclvzsiwsgkjq';                  // SMTP password
        ...
        //Recipients
        $mail->setFrom('tmtkimk19012@cusc.ctu.edu.vn', 'Test Mail');
        $mail->addAddress($kh_email);                          // Add a recipient
        $mail->addReplyTo('kimtruong0211@gmai.com', 'Người quản trị Website');
        ...
        <table>
            <tr>
                <td><h1 style="color: red; font-size: 16px; text-align: center;">KIM's Garden</h1>
            ...
            <tr>
                <td>
                    ...
                    <a href="$siteUrl/webPHP/backend/pages/kichhoattaikhoan.php?kh_tendangnhap=$kh_tendangnhap&kh_makichhoat=$kh_makichhoat">Kích hoạt tài khoản</a>
                </td>
            </tr>
            <tr>
                <td>
